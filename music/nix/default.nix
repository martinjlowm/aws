{
  ...
  bundles = [
    {
      key = "beatport_tracks_2023-11 (1).zip";
      outputHash = "sha256-cyKYjMVeM0oPxMP+JFlVVDsr6KZPuU/sIpjk+WQXxGc=";
    }
    {
      key = "beatport_tracks_2023-11.zip";
      outputHash = "sha256-u2ufc0zWi0uWqPGuiqVP7XzpuKJoNfJdf6aH79hPX6g=";
    }
    {
      key = "beatport_tracks_2023-12 (1).zip";
      outputHash = "sha256-ea8OJ9FZn2ccaXq48O+FL0IzWnd+ZeWCatVS4gcxiqw=";
    }
    {
      key = "beatport_tracks_2023-12 (2).zip";
      outputHash = "sha256-nPWtoiNWfzK1E7zNz3yIfIuIYHnCy4K4y5X2qlp12L4=";
    }
    {
      key = "beatport_tracks_2023-12.zip";
      outputHash = "sha256-rF1lreMOFzBE++qeLZIg9kFEsqumn7nnfNOMF0WpAe0=";
    }
    {
      key = "beatport_tracks_2024-01.zip";
      outputHash = "sha256-mQcls6wKg60sT0IpWhXNkqUoPsZ3iQVuCi/JUG8/Af8=";
    }
    {
      key = "beatport_tracks_2024-05.zip";
      outputHash = "sha256-ewOKG0bi1uDi6ihQOMdu5mPG8i9ylk1glF8h3WBYs5Y=";
    }
    {
      key = "beatport_tracks_2024-07.zip";
      outputHash = "sha256-O18ehvRmS8qtfiGrWgSuomxY3wV5XCODMncL43j/THo=";
    }
    {
      key = "beatport_tracks_2024-08.zip";
      outputHash = "sha256-ehV/Knv7nTNkTr/iv7EamWb5YZJUbnlJxfZajqoGNLY=";
    }
    {
      key = "beatport_tracks_2024-10-2.zip";
      outputHash = "sha256-01rlwZGxsq5RnOjol7Dh45LnUPTN4PuJJXIl8PMHeWw=";
    }
    {
      key = "beatport_tracks_2024-10.zip";
      outputHash = "sha256-ic+Egn0ecBJwBZiKbmg52u4vyDB3u1EZdG5rvGIhHeY=";
    }
  ];
